...
const MainTitle = memo(({ title }) => {
  ...
  return (
    <div className="space-y-3" data-aos="fade-up" data-aos-delay="600">
      <h1 className="text-4xl sm:text-6xl md:text-6xl lg:text-6xl xl:text-7xl font-bold" style={{ letterSpacing: '0.05em' }}>
        {/* First Line */}
...
LaptopShowcase.displayName = 'LaptopShowcase';
...
const Home = () => {
  ...
  const [profileData, setProfileData] = useState({
    ...
    subtitle: ["Ethical Hacking", "Penetration Tester"],
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light text-justify"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  A passionate cybersecurity enthusiast focused on safeguarding digital systems from modern cyber threats. I enjoy exploring how attacks happen, analyzing vulnerabilities, and strengthening defenses through secure design and continuous learning. With a strong interest in ethical hacking, digital forensics, and cyber defense, I am ready to grow and contribute in the ever-evolving world of cybersecurity.
                </p>

                {/* Tech Stack */}
                <div className="flex flex-wrap gap-3 justify-start" data-aos="fade-up" data-aos-delay="1200">
                  {Array.isArray(profileData.tech_stack) &&
                    profileData.tech_stack.map((tech, index) => (
                      <div 
                        key={tech}
                        className="px-3 py-1 rounded-full text-sm bg-white/10 text-gray-200 backdrop-blur">
                        {tech}
                      </div>
                    ))
                  }
